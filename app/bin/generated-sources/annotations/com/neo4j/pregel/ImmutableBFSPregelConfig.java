...
public final class ImmutableBFSPregelConfig implements BFSPregelConfig {
   ...
   */
  public final ImmutableBFSPregelConfig withUsernameOverride(String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBFSPregelConfig withRelationshipWeightProperty(String value) {
    String newValue = value;
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link BFSPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * @param value The value for arrowConnectionInfo, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBFSPregelConfig withArrowConnectionInfo(WriteConfig.ArrowConnectionInfo value) {
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link BFSPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * A shallow reference equality check is used on unboxed optional value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for arrowConnectionInfo
   * @return A modified copy of {@code this} object
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableBFSPregelConfig withArrowConnectionInfo(Optional<? extends WriteConfig.ArrowConnectionInfo> optional) {
   ...
   */
  public static BFSPregelConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, Optional<WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, long startNode) {
   ...
   * @return An immutable BFSPregelConfig instance
   */
  public static BFSPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, Optional<? extends WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, long startNode) {
    return validate(new ImmutableBFSPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, startNode));
  }
   ...
   * @return An immutable BFSPregelConfig instance
   */
  public static BFSPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, String relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, WriteConfig.ArrowConnectionInfo arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, long startNode) {
    return validate(new ImmutableBFSPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, startNode));
  }
   ...
   *    .arrowConnectionInfo(org.neo4j.gds.config.WriteConfig.ArrowConnectionInfo) // optional {@link BFSPregelConfig#arrowConnectionInfo() arrowConnectionInfo}
  ...
  public static final class Builder {
    ...
    /**
     * Initializes the optional value {@link BFSPregelConfig#arrowConnectionInfo() arrowConnectionInfo} to arrowConnectionInfo.
