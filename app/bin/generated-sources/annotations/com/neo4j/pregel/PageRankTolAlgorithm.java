...
public final class PageRankTolAlgorithm extends Algorithm<PregelResult> {
    private final Pregel<PageRankTol.PrTolConfig> pregelJob;

    PageRankTolAlgorithm(Graph graph, PageRankTol.PrTolConfig configuration,
