...
public final class ImmutableConnectedComponentsConfig implements ConnectedComponentsConfig {
   ...
   */
  public final ImmutableConnectedComponentsConfig withUsernameOverride(String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableConnectedComponentsConfig withRelationshipWeightProperty(String value) {
    String newValue = value;
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link ConnectedComponentsConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * @param value The value for arrowConnectionInfo, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutableConnectedComponentsConfig withArrowConnectionInfo(WriteConfig.ArrowConnectionInfo value) {
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link ConnectedComponentsConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * A shallow reference equality check is used on unboxed optional value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for arrowConnectionInfo
   * @return A modified copy of {@code this} object
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableConnectedComponentsConfig withArrowConnectionInfo(Optional<? extends WriteConfig.ArrowConnectionInfo> optional) {
   ...
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableConnectedComponentsConfig withSeedProperty(@Nullable String value) {
  ...
  /**
   * Computes a hash code from attributes: {@code logProgress}, {@code sudo}, {@code usernameOverride}, {@code concurrency}, {@code minBatchSize}, {@code jobId}, {@code nodeLabels}, {@code relationshipTypes}, {@code hasRelationshipWeightProperty}, {@code relationshipWeightProperty}, {@code maxIterations}, {@code partitioning}, {@code useForkJoin}, {@code arrowConnectionInfo}, {@code writeConcurrency}, {@code mutateProperty}, {@code writeProperty}, {@code seedProperty}, {@code isAsynchronous}.
   ...
   */
  public static ConnectedComponentsConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, Partitioning partitioning, Optional<WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty, boolean isAsynchronous) {
    return of(concurrency, minBatchSize, (Iterable<String>) nodeLabels, (Iterable<String>) relationshipTypes, relationshipWeightProperty, maxIterations, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty, isAsynchronous);
  }
   ...
   * @return An immutable ConnectedComponentsConfig instance
   */
  public static ConnectedComponentsConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, Partitioning partitioning, Optional<? extends WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty, boolean isAsynchronous) {
    return validate(new ImmutableConnectedComponentsConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty, isAsynchronous));
  }
   ...
   * @return An immutable ConnectedComponentsConfig instance
   */
  public static ConnectedComponentsConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, String relationshipWeightProperty, int maxIterations, Partitioning partitioning, WriteConfig.ArrowConnectionInfo arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty, boolean isAsynchronous) {
    return validate(new ImmutableConnectedComponentsConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty, isAsynchronous));
  }
   ...
   *    .arrowConnectionInfo(org.neo4j.gds.config.WriteConfig.ArrowConnectionInfo) // optional {@link ConnectedComponentsConfig#arrowConnectionInfo() arrowConnectionInfo}
  ...
  public static final class Builder {
    ...
    /**
     * Initializes the optional value {@link ConnectedComponentsConfig#arrowConnectionInfo() arrowConnectionInfo} to arrowConnectionInfo.
