...
public final class BFSParentPregelAlgorithm extends Algorithm<PregelResult> {
    private final Pregel<BFSPregelConfig> pregelJob;

    BFSParentPregelAlgorithm(Graph graph, BFSPregelConfig configuration,
            ProgressTracker progressTracker) {
        super(progressTracker);
        this.pregelJob = Pregel.create(graph, configuration, new BFSParentPregel(), Pools.DEFAULT, progressTracker);
    }
