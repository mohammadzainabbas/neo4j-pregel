...
public final class ConnectedComponentsPregelStreamProc extends PregelStreamProc<ConnectedComponentsPregelAlgorithm, ConnectedComponentsConfig> {
    @Procedure(
            name = "esilv.pregel.cc.stream",
            mode = Mode.READ
    )
    ...
    @Procedure(
            name = "esilv.pregel.cc.stream.estimate",
            mode = Mode.READ
    )
