...
/**
 * Immutable implementation of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig}.
 * <p>
 * Use the builder to create immutable instances:
 * {@code ImmutablePathsMiningGADMPregelConfig.builder()}.
 * Use the static factory method to create immutable instances:
 * {@code ImmutablePathsMiningGADMPregelConfig.of()}.
 */
@Generated(from = "PathsMiningGADMPregel.PathsMiningGADMPregelConfig", generator = "Immutables")
@SuppressWarnings({"all"})
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
public final class ImmutablePathsMiningGADMPregelConfig
    implements PathsMiningGADMPregel.PathsMiningGADMPregelConfig {
  ...
  private ImmutablePathsMiningGADMPregelConfig(
      int concurrency,
      int minBatchSize,
  ...
  private ImmutablePathsMiningGADMPregelConfig(ImmutablePathsMiningGADMPregelConfig.Builder builder) {
  ...
  private final class InitShim {
    ...
    private String formatInitCycleMessage() {
      ...
      return "Cannot build PathsMiningGADMPregelConfig, attribute initializers form cycle " + attributes;
    }
  }

  private Collection<String> configKeysInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.configKeys();
  }

  private boolean logProgressInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.logProgress();
  }

  private boolean sudoInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.sudo();
  }

  private Map<String, Object> toMapInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.toMap();
  }

  private int concurrencyInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.concurrency();
  }

  private int minBatchSizeInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.minBatchSize();
  }

  private JobId jobIdInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.jobId();
  }

  private List<String> nodeLabelsInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.nodeLabels();
  }

  private List<String> relationshipTypesInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.relationshipTypes();
  }

  private boolean hasRelationshipWeightPropertyInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.hasRelationshipWeightProperty();
  }

  private Partitioning partitioningInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.partitioning();
  }

  private boolean useForkJoinInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.useForkJoin();
  }

  private int writeConcurrencyInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.writeConcurrency();
  }

  private String mutatePropertyInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.mutateProperty();
  }

  private String writePropertyInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.writeProperty();
  }

  private @Nullable String seedPropertyInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.seedProperty();
  }

  private boolean isEncodedOutputInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.isEncodedOutput();
  }

  private long identifierInitialize() {
    return PathsMiningGADMPregel.PathsMiningGADMPregelConfig.super.identifier();
  }
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#configKeys() configKeys} attribute.
   * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for configKeys
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withConfigKeys(Collection<String> value) {
    if (this.configKeys == value) return this;
    Collection<String> newValue = Objects.requireNonNull(value, "configKeys");
    return validate(new ImmutablePathsMiningGADMPregelConfig(
        newValue,
        this.logProgress,
        this.sudo,
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#logProgress() logProgress} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for logProgress
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withLogProgress(boolean value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#sudo() sudo} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for sudo
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withSudo(boolean value) {
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#usernameOverride() usernameOverride} attribute.
   * @param value The value for usernameOverride, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withUsernameOverride(String value) {
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#usernameOverride() usernameOverride} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for usernameOverride
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withUsernameOverride(Optional<String> optional) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#concurrency() concurrency} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for concurrency
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withConcurrency(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#minBatchSize() minBatchSize} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for minBatchSize
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withMinBatchSize(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#jobId() jobId} attribute.
   * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for jobId
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withJobId(JobId value) {
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#nodeLabels() nodeLabels}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withNodeLabels(String... elements) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withNodeLabels(Iterable<String> elements) {
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipTypes() relationshipTypes}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withRelationshipTypes(String... elements) {
    List<String> newValue = createUnmodifiableList(false, createSafeList(Arrays.asList(elements), true, false));
    return validate(new ImmutablePathsMiningGADMPregelConfig(
        this.configKeys,
        this.logProgress,
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withRelationshipTypes(Iterable<String> elements) {
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipWeightProperty() relationshipWeightProperty} attribute.
   * @param value The value for relationshipWeightProperty, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withRelationshipWeightProperty(String value) {
    String newValue = value;
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipWeightProperty() relationshipWeightProperty} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for relationshipWeightProperty
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withRelationshipWeightProperty(Optional<String> optional) {
    String value = optional.orElse(null);
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#maxIterations() maxIterations} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for maxIterations
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withMaxIterations(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#partitioning() partitioning} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for partitioning
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withPartitioning(Partitioning value) {
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * @param value The value for arrowConnectionInfo, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withArrowConnectionInfo(WriteConfig.ArrowConnectionInfo value) {
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * A shallow reference equality check is used on unboxed optional value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for arrowConnectionInfo
   * @return A modified copy of {@code this} object
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutablePathsMiningGADMPregelConfig withArrowConnectionInfo(Optional<? extends WriteConfig.ArrowConnectionInfo> optional) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeConcurrency() writeConcurrency} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for writeConcurrency
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withWriteConcurrency(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#mutateProperty() mutateProperty} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for mutateProperty
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withMutateProperty(String value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeProperty() writeProperty} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for writeProperty
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withWriteProperty(String value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#seedProperty() seedProperty} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for seedProperty (can be {@code null})
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withSeedProperty(@Nullable String value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#isEncodedOutput() isEncodedOutput} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for isEncodedOutput
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withIsEncodedOutput(boolean value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#identifier() identifier} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for identifier
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePathsMiningGADMPregelConfig withIdentifier(long value) {
  ...
  /**
   * This instance is equal to all instances of {@code ImmutablePathsMiningGADMPregelConfig} that have equal attribute values.
   * @return {@code true} if {@code this} is equal to {@code another} instance
   */
  @Override
  public boolean equals(Object another) {
    if (this == another) return true;
    return another instanceof ImmutablePathsMiningGADMPregelConfig
        && equalTo((ImmutablePathsMiningGADMPregelConfig) another);
  }

  private boolean equalTo(ImmutablePathsMiningGADMPregelConfig another) {
  ...
  /**
   * Prints the immutable value {@code PathsMiningGADMPregelConfig} with attribute values.
   * @return A string representation of the value
   */
  @Override
  public String toString() {
    StringBuilder builder = new StringBuilder("PathsMiningGADMPregelConfig{");
  ...
  /**
   * Construct a new immutable {@code PathsMiningGADMPregelConfig} instance.
   ...
   * @return An immutable PathsMiningGADMPregelConfig instance
   */
  public static PathsMiningGADMPregel.PathsMiningGADMPregelConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, Partitioning partitioning, Optional<WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty, boolean isEncodedOutput, long identifier) {
   ...
   * @return An immutable PathsMiningGADMPregelConfig instance
   */
  public static PathsMiningGADMPregel.PathsMiningGADMPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, Partitioning partitioning, Optional<? extends WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty, boolean isEncodedOutput, long identifier) {
    return validate(new ImmutablePathsMiningGADMPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty, isEncodedOutput, identifier));
  }
   ...
   * @return An immutable PathsMiningGADMPregelConfig instance
   */
  public static PathsMiningGADMPregel.PathsMiningGADMPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, String relationshipWeightProperty, int maxIterations, Partitioning partitioning, WriteConfig.ArrowConnectionInfo arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty, boolean isEncodedOutput, long identifier) {
    return validate(new ImmutablePathsMiningGADMPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty, isEncodedOutput, identifier));
  }

  private static ImmutablePathsMiningGADMPregelConfig validate(ImmutablePathsMiningGADMPregelConfig instance) {
  ...
  /**
   * Creates an immutable copy of a {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig} value.
   * Uses accessors to get values to initialize the new immutable instance.
   * If an instance is already immutable, it is returned as is.
   * @param instance The instance to copy
   * @return A copied immutable PathsMiningGADMPregelConfig instance
   */
  public static PathsMiningGADMPregel.PathsMiningGADMPregelConfig copyOf(PathsMiningGADMPregel.PathsMiningGADMPregelConfig instance) {
    if (instance instanceof ImmutablePathsMiningGADMPregelConfig) {
      return (ImmutablePathsMiningGADMPregelConfig) instance;
    }
    return ImmutablePathsMiningGADMPregelConfig.builder()
        .from(instance)
        .build();
  }

  /**
   * Creates a builder for {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig PathsMiningGADMPregelConfig}.
   * <pre>
   * ImmutablePathsMiningGADMPregelConfig.builder()
   *    .configKeys(Collection&amp;lt;String&amp;gt;) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#configKeys() configKeys}
   *    .logProgress(boolean) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#logProgress() logProgress}
   *    .sudo(boolean) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#sudo() sudo}
   *    .usernameOverride(String) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#usernameOverride() usernameOverride}
   *    .concurrency(int) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#concurrency() concurrency}
   *    .minBatchSize(int) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#minBatchSize() minBatchSize}
   *    .jobId(org.neo4j.gds.core.utils.progress.JobId) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#jobId() jobId}
   *    .addNodeLabel|addAllNodeLabels(String) // {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#nodeLabels() nodeLabels} elements
   *    .addRelationshipType|addAllRelationshipTypes(String) // {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipTypes() relationshipTypes} elements
   *    .relationshipWeightProperty(String) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipWeightProperty() relationshipWeightProperty}
   *    .maxIterations(int) // required {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#maxIterations() maxIterations}
   *    .partitioning(org.neo4j.gds.beta.pregel.Partitioning) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#partitioning() partitioning}
   *    .arrowConnectionInfo(org.neo4j.gds.config.WriteConfig.ArrowConnectionInfo) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#arrowConnectionInfo() arrowConnectionInfo}
   *    .writeConcurrency(int) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeConcurrency() writeConcurrency}
   *    .mutateProperty(String) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#mutateProperty() mutateProperty}
   *    .writeProperty(String) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeProperty() writeProperty}
   *    .seedProperty(String | null) // nullable {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#seedProperty() seedProperty}
   *    .isEncodedOutput(boolean) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#isEncodedOutput() isEncodedOutput}
   *    .identifier(long) // optional {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#identifier() identifier}
   *    .build();
   * </pre>
   * @return A new PathsMiningGADMPregelConfig builder
   */
  public static ImmutablePathsMiningGADMPregelConfig.Builder builder() {
    return new ImmutablePathsMiningGADMPregelConfig.Builder();
  }

  /**
   * Builds instances of type {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig PathsMiningGADMPregelConfig}.
  ...
  public static final class Builder {
    ...
    /**
     * Fill a builder with attribute values from the provided {@code com.neo4j.pregel.PathsMiningGADMPregel.PathsMiningGADMPregelConfig} instance.
     * @param instance The instance from which to copy values
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder from(PathsMiningGADMPregel.PathsMiningGADMPregelConfig instance) {
      Objects.requireNonNull(instance, "instance");
      from((Object) instance);
      return this;
    }
    ...
    private void from(Object object) {
      ...
      if (object instanceof PathsMiningGADMPregel.PathsMiningGADMPregelConfig) {
        PathsMiningGADMPregel.PathsMiningGADMPregelConfig instance = (PathsMiningGADMPregel.PathsMiningGADMPregelConfig) object;
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#configKeys() configKeys} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#configKeys() configKeys}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#logProgress() logProgress} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#logProgress() logProgress}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#sudo() sudo} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#sudo() sudo}.</em>
    ...
    /**
     * Initializes the optional value {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#usernameOverride() usernameOverride} to usernameOverride.
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#concurrency() concurrency} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#concurrency() concurrency}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#minBatchSize() minBatchSize} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#minBatchSize() minBatchSize}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#jobId() jobId} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#jobId() jobId}.</em>
    ...
    /**
     * Adds one element to {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#nodeLabels() nodeLabels} list.
    ...
    /**
     * Adds elements to {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#nodeLabels() nodeLabels} list.
    ...
    /**
     * Sets or replaces all elements for {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#nodeLabels() nodeLabels} list.
    ...
    /**
     * Adds one element to {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipTypes() relationshipTypes} list.
    ...
    /**
     * Adds elements to {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipTypes() relationshipTypes} list.
    ...
    /**
     * Sets or replaces all elements for {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipTypes() relationshipTypes} list.
    ...
    /**
     * Initializes the optional value {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#relationshipWeightProperty() relationshipWeightProperty} to relationshipWeightProperty.
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#maxIterations() maxIterations} attribute.
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#partitioning() partitioning} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#partitioning() partitioning}.</em>
    ...
    /**
     * Initializes the optional value {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#arrowConnectionInfo() arrowConnectionInfo} to arrowConnectionInfo.
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeConcurrency() writeConcurrency} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeConcurrency() writeConcurrency}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#mutateProperty() mutateProperty} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#mutateProperty() mutateProperty}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeProperty() writeProperty} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#writeProperty() writeProperty}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#seedProperty() seedProperty} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#seedProperty() seedProperty}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#isEncodedOutput() isEncodedOutput} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#isEncodedOutput() isEncodedOutput}.</em>
    ...
    /**
     * Initializes the value for the {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#identifier() identifier} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig#identifier() identifier}.</em>
    ...
    /**
     * Builds a new {@link PathsMiningGADMPregel.PathsMiningGADMPregelConfig PathsMiningGADMPregelConfig}.
     * @return An immutable instance of PathsMiningGADMPregelConfig
    ...
    public PathsMiningGADMPregel.PathsMiningGADMPregelConfig build() {
      ...
      return ImmutablePathsMiningGADMPregelConfig.validate(new ImmutablePathsMiningGADMPregelConfig(this));
    }
    ...
    private String formatRequiredAttributesMessage() {
      ...
      return "Cannot build PathsMiningGADMPregelConfig, some of required attributes are not set " + attributes;
    }
  }
