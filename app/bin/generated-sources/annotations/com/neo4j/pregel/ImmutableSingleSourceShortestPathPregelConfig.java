...
public final class ImmutableSingleSourceShortestPathPregelConfig
   ...
   */
  public final ImmutableSingleSourceShortestPathPregelConfig withUsernameOverride(@Nullable String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSingleSourceShortestPathPregelConfig withRelationshipWeightProperty(@Nullable String value) {
    @Nullable String newValue = value;
   ...
   */
  public static SingleSourceShortestPathPregel.SingleSourceShortestPathPregelConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, long startNode) {
   ...
   * @return An immutable SingleSourceShortestPathPregelConfig instance
   */
  public static SingleSourceShortestPathPregel.SingleSourceShortestPathPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, long startNode) {
    return validate(new ImmutableSingleSourceShortestPathPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, writeConcurrency, mutateProperty, writeProperty, startNode));
  }
   ...
   * @return An immutable SingleSourceShortestPathPregelConfig instance
   */
  public static SingleSourceShortestPathPregel.SingleSourceShortestPathPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, @Nullable String relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, long startNode) {
    return validate(new ImmutableSingleSourceShortestPathPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, writeConcurrency, mutateProperty, writeProperty, startNode));
  }
