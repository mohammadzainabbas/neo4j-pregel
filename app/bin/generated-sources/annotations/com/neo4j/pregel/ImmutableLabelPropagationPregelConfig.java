...
/**
 * Immutable implementation of {@link LabelPropagationPregel.LabelPropagationPregelConfig}.
 * <p>
 * Use the builder to create immutable instances:
 * {@code ImmutableLabelPropagationPregelConfig.builder()}.
 * Use the static factory method to create immutable instances:
 * {@code ImmutableLabelPropagationPregelConfig.of()}.
 */
@Generated(from = "LabelPropagationPregel.LabelPropagationPregelConfig", generator = "Immutables")
@SuppressWarnings({"all"})
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
public final class ImmutableLabelPropagationPregelConfig
    implements LabelPropagationPregel.LabelPropagationPregelConfig {
  ...
  private ImmutableLabelPropagationPregelConfig(
      int concurrency,
      int minBatchSize,
  ...
  private ImmutableLabelPropagationPregelConfig(ImmutableLabelPropagationPregelConfig.Builder builder) {
  ...
  private final class InitShim {
    ...
    private String formatInitCycleMessage() {
      ...
      return "Cannot build LabelPropagationPregelConfig, attribute initializers form cycle " + attributes;
    }
  }

  private Collection<String> configKeysInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.configKeys();
  }

  private boolean logProgressInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.logProgress();
  }

  private boolean sudoInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.sudo();
  }

  private Map<String, Object> toMapInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.toMap();
  }

  private int concurrencyInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.concurrency();
  }

  private int minBatchSizeInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.minBatchSize();
  }

  private JobId jobIdInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.jobId();
  }

  private List<String> nodeLabelsInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.nodeLabels();
  }

  private List<String> relationshipTypesInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.relationshipTypes();
  }

  private boolean hasRelationshipWeightPropertyInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.hasRelationshipWeightProperty();
  }

  private boolean isAsynchronousInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.isAsynchronous();
  }

  private Partitioning partitioningInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.partitioning();
  }

  private boolean useForkJoinInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.useForkJoin();
  }

  private int writeConcurrencyInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.writeConcurrency();
  }

  private String mutatePropertyInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.mutateProperty();
  }

  private String writePropertyInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.writeProperty();
  }

  private @Nullable String seedPropertyInitialize() {
    return LabelPropagationPregel.LabelPropagationPregelConfig.super.seedProperty();
  }
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#configKeys() configKeys} attribute.
   * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for configKeys
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withConfigKeys(Collection<String> value) {
    if (this.configKeys == value) return this;
    Collection<String> newValue = Objects.requireNonNull(value, "configKeys");
    return validate(new ImmutableLabelPropagationPregelConfig(
        newValue,
        this.logProgress,
        this.sudo,
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#logProgress() logProgress} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for logProgress
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withLogProgress(boolean value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#sudo() sudo} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for sudo
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withSudo(boolean value) {
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#usernameOverride() usernameOverride} attribute.
   * @param value The value for usernameOverride, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withUsernameOverride(String value) {
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#usernameOverride() usernameOverride} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for usernameOverride
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withUsernameOverride(Optional<String> optional) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#concurrency() concurrency} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for concurrency
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withConcurrency(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#minBatchSize() minBatchSize} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for minBatchSize
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withMinBatchSize(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#jobId() jobId} attribute.
   * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for jobId
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withJobId(JobId value) {
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link LabelPropagationPregel.LabelPropagationPregelConfig#nodeLabels() nodeLabels}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withNodeLabels(String... elements) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withNodeLabels(Iterable<String> elements) {
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipTypes() relationshipTypes}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withRelationshipTypes(String... elements) {
    List<String> newValue = createUnmodifiableList(false, createSafeList(Arrays.asList(elements), true, false));
    return validate(new ImmutableLabelPropagationPregelConfig(
        this.configKeys,
        this.logProgress,
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withRelationshipTypes(Iterable<String> elements) {
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipWeightProperty() relationshipWeightProperty} attribute.
   * @param value The value for relationshipWeightProperty, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withRelationshipWeightProperty(String value) {
    String newValue = value;
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipWeightProperty() relationshipWeightProperty} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for relationshipWeightProperty
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withRelationshipWeightProperty(Optional<String> optional) {
    String value = optional.orElse(null);
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#maxIterations() maxIterations} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for maxIterations
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withMaxIterations(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#isAsynchronous() isAsynchronous} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for isAsynchronous
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withIsAsynchronous(boolean value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#partitioning() partitioning} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for partitioning
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withPartitioning(Partitioning value) {
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * @param value The value for arrowConnectionInfo, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withArrowConnectionInfo(WriteConfig.ArrowConnectionInfo value) {
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * A shallow reference equality check is used on unboxed optional value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for arrowConnectionInfo
   * @return A modified copy of {@code this} object
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableLabelPropagationPregelConfig withArrowConnectionInfo(Optional<? extends WriteConfig.ArrowConnectionInfo> optional) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeConcurrency() writeConcurrency} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for writeConcurrency
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withWriteConcurrency(int value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#mutateProperty() mutateProperty} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for mutateProperty
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withMutateProperty(String value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeProperty() writeProperty} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for writeProperty
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withWriteProperty(String value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#seedProperty() seedProperty} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for seedProperty (can be {@code null})
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withSeedProperty(@Nullable String value) {
  ...
  /**
   * This instance is equal to all instances of {@code ImmutableLabelPropagationPregelConfig} that have equal attribute values.
   * @return {@code true} if {@code this} is equal to {@code another} instance
   */
  @Override
  public boolean equals(Object another) {
    if (this == another) return true;
    return another instanceof ImmutableLabelPropagationPregelConfig
        && equalTo((ImmutableLabelPropagationPregelConfig) another);
  }

  private boolean equalTo(ImmutableLabelPropagationPregelConfig another) {
  ...
  /**
   * Prints the immutable value {@code LabelPropagationPregelConfig} with attribute values.
   * @return A string representation of the value
   */
  @Override
  public String toString() {
    StringBuilder builder = new StringBuilder("LabelPropagationPregelConfig{");
  ...
  /**
   * Construct a new immutable {@code LabelPropagationPregelConfig} instance.
   ...
   * @return An immutable LabelPropagationPregelConfig instance
   */
  public static LabelPropagationPregel.LabelPropagationPregelConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, Optional<WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty) {
    return of(concurrency, minBatchSize, (Iterable<String>) nodeLabels, (Iterable<String>) relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty);
  }
   ...
   * @return An immutable LabelPropagationPregelConfig instance
   */
  public static LabelPropagationPregel.LabelPropagationPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, Optional<? extends WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty) {
    return validate(new ImmutableLabelPropagationPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty));
  }
   ...
   * @return An immutable LabelPropagationPregelConfig instance
   */
  public static LabelPropagationPregel.LabelPropagationPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, String relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, WriteConfig.ArrowConnectionInfo arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, @Nullable String seedProperty) {
    return validate(new ImmutableLabelPropagationPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, seedProperty));
  }

  private static ImmutableLabelPropagationPregelConfig validate(ImmutableLabelPropagationPregelConfig instance) {
  ...
  /**
   * Creates an immutable copy of a {@link LabelPropagationPregel.LabelPropagationPregelConfig} value.
   * Uses accessors to get values to initialize the new immutable instance.
   * If an instance is already immutable, it is returned as is.
   * @param instance The instance to copy
   * @return A copied immutable LabelPropagationPregelConfig instance
   */
  public static LabelPropagationPregel.LabelPropagationPregelConfig copyOf(LabelPropagationPregel.LabelPropagationPregelConfig instance) {
    if (instance instanceof ImmutableLabelPropagationPregelConfig) {
      return (ImmutableLabelPropagationPregelConfig) instance;
    }
    return ImmutableLabelPropagationPregelConfig.builder()
        .from(instance)
        .build();
  }

  /**
   * Creates a builder for {@link LabelPropagationPregel.LabelPropagationPregelConfig LabelPropagationPregelConfig}.
   * <pre>
   * ImmutableLabelPropagationPregelConfig.builder()
   *    .configKeys(Collection&amp;lt;String&amp;gt;) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#configKeys() configKeys}
   *    .logProgress(boolean) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#logProgress() logProgress}
   *    .sudo(boolean) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#sudo() sudo}
   *    .usernameOverride(String) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#usernameOverride() usernameOverride}
   *    .concurrency(int) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#concurrency() concurrency}
   *    .minBatchSize(int) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#minBatchSize() minBatchSize}
   *    .jobId(org.neo4j.gds.core.utils.progress.JobId) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#jobId() jobId}
   *    .addNodeLabel|addAllNodeLabels(String) // {@link LabelPropagationPregel.LabelPropagationPregelConfig#nodeLabels() nodeLabels} elements
   *    .addRelationshipType|addAllRelationshipTypes(String) // {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipTypes() relationshipTypes} elements
   *    .relationshipWeightProperty(String) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipWeightProperty() relationshipWeightProperty}
   *    .maxIterations(int) // required {@link LabelPropagationPregel.LabelPropagationPregelConfig#maxIterations() maxIterations}
   *    .isAsynchronous(boolean) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#isAsynchronous() isAsynchronous}
   *    .partitioning(org.neo4j.gds.beta.pregel.Partitioning) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#partitioning() partitioning}
   *    .arrowConnectionInfo(org.neo4j.gds.config.WriteConfig.ArrowConnectionInfo) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#arrowConnectionInfo() arrowConnectionInfo}
   *    .writeConcurrency(int) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeConcurrency() writeConcurrency}
   *    .mutateProperty(String) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#mutateProperty() mutateProperty}
   *    .writeProperty(String) // optional {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeProperty() writeProperty}
   *    .seedProperty(String | null) // nullable {@link LabelPropagationPregel.LabelPropagationPregelConfig#seedProperty() seedProperty}
   *    .build();
   * </pre>
   * @return A new LabelPropagationPregelConfig builder
   */
  public static ImmutableLabelPropagationPregelConfig.Builder builder() {
    return new ImmutableLabelPropagationPregelConfig.Builder();
  }

  /**
   * Builds instances of type {@link LabelPropagationPregel.LabelPropagationPregelConfig LabelPropagationPregelConfig}.
  ...
  public static final class Builder {
    ...
    /**
     * Fill a builder with attribute values from the provided {@code com.neo4j.pregel.LabelPropagationPregel.LabelPropagationPregelConfig} instance.
     * @param instance The instance from which to copy values
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder from(LabelPropagationPregel.LabelPropagationPregelConfig instance) {
      Objects.requireNonNull(instance, "instance");
      from((Object) instance);
      return this;
    }
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#configKeys() configKeys} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#configKeys() configKeys}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#logProgress() logProgress} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#logProgress() logProgress}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#sudo() sudo} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#sudo() sudo}.</em>
    ...
    /**
     * Initializes the optional value {@link LabelPropagationPregel.LabelPropagationPregelConfig#usernameOverride() usernameOverride} to usernameOverride.
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#concurrency() concurrency} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#concurrency() concurrency}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#minBatchSize() minBatchSize} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#minBatchSize() minBatchSize}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#jobId() jobId} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#jobId() jobId}.</em>
    ...
    /**
     * Adds one element to {@link LabelPropagationPregel.LabelPropagationPregelConfig#nodeLabels() nodeLabels} list.
    ...
    /**
     * Adds elements to {@link LabelPropagationPregel.LabelPropagationPregelConfig#nodeLabels() nodeLabels} list.
    ...
    /**
     * Sets or replaces all elements for {@link LabelPropagationPregel.LabelPropagationPregelConfig#nodeLabels() nodeLabels} list.
    ...
    /**
     * Adds one element to {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipTypes() relationshipTypes} list.
    ...
    /**
     * Adds elements to {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipTypes() relationshipTypes} list.
    ...
    /**
     * Sets or replaces all elements for {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipTypes() relationshipTypes} list.
    ...
    /**
     * Initializes the optional value {@link LabelPropagationPregel.LabelPropagationPregelConfig#relationshipWeightProperty() relationshipWeightProperty} to relationshipWeightProperty.
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#maxIterations() maxIterations} attribute.
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#isAsynchronous() isAsynchronous} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#isAsynchronous() isAsynchronous}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#partitioning() partitioning} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#partitioning() partitioning}.</em>
    ...
    /**
     * Initializes the optional value {@link LabelPropagationPregel.LabelPropagationPregelConfig#arrowConnectionInfo() arrowConnectionInfo} to arrowConnectionInfo.
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeConcurrency() writeConcurrency} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeConcurrency() writeConcurrency}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#mutateProperty() mutateProperty} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#mutateProperty() mutateProperty}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeProperty() writeProperty} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#writeProperty() writeProperty}.</em>
    ...
    /**
     * Initializes the value for the {@link LabelPropagationPregel.LabelPropagationPregelConfig#seedProperty() seedProperty} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link LabelPropagationPregel.LabelPropagationPregelConfig#seedProperty() seedProperty}.</em>
    ...
    /**
     * Builds a new {@link LabelPropagationPregel.LabelPropagationPregelConfig LabelPropagationPregelConfig}.
     * @return An immutable instance of LabelPropagationPregelConfig
    ...
    public LabelPropagationPregel.LabelPropagationPregelConfig build() {
      ...
      return ImmutableLabelPropagationPregelConfig.validate(new ImmutableLabelPropagationPregelConfig(this));
    }
    ...
    private String formatRequiredAttributesMessage() {
      ...
      return "Cannot build LabelPropagationPregelConfig, some of required attributes are not set " + attributes;
    }
  }
