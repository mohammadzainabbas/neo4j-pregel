...
public final class ImmutableLabelPropagationPregelConfig
   ...
   */
  public final ImmutableLabelPropagationPregelConfig withUsernameOverride(@Nullable String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withRelationshipWeightProperty(@Nullable String value) {
    @Nullable String newValue = value;
   ...
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableLabelPropagationPregelConfig withSeedProperty(@org.jetbrains.annotations.Nullable String value) {
   ...
   */
  public static LabelPropagationPregel.LabelPropagationPregelConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, @org.jetbrains.annotations.Nullable String seedProperty) {
    return of(concurrency, minBatchSize, (Iterable<String>) nodeLabels, (Iterable<String>) relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, writeConcurrency, mutateProperty, writeProperty, seedProperty);
  }
   ...
   * @return An immutable LabelPropagationPregelConfig instance
   */
  public static LabelPropagationPregel.LabelPropagationPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, @org.jetbrains.annotations.Nullable String seedProperty) {
    return validate(new ImmutableLabelPropagationPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, writeConcurrency, mutateProperty, writeProperty, seedProperty));
  }
   ...
   * @return An immutable LabelPropagationPregelConfig instance
   */
  public static LabelPropagationPregel.LabelPropagationPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, @Nullable String relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, @org.jetbrains.annotations.Nullable String seedProperty) {
    return validate(new ImmutableLabelPropagationPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, writeConcurrency, mutateProperty, writeProperty, seedProperty));
  }
