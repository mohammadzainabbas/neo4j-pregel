...
public final class FrequentSubgraphMiningPregelMutateProc extends PregelMutateProc<FrequentSubgraphMiningPregelAlgorithm, FrequentSubgraphMiningPregel.FrequentSubgraphMiningPregelConfig> {
    @Procedure(
            name = "esilv.pregel.fsm.mutate",
            mode = Mode.READ
    )
    ...
    protected AbstractResultBuilder<PregelMutateResult> resultBuilder(
            ComputationResult<FrequentSubgraphMiningPregelAlgorithm, PregelResult, FrequentSubgraphMiningPregel.FrequentSubgraphMiningPregelConfig> computeResult,
