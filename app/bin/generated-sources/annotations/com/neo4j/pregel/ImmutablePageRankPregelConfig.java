...
public final class ImmutablePageRankPregelConfig
   ...
   */
  public final ImmutablePageRankPregelConfig withUsernameOverride(@Nullable String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutablePageRankPregelConfig withRelationshipWeightProperty(@Nullable String value) {
    @Nullable String newValue = value;
   ...
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePageRankPregelConfig withSeedProperty(@org.jetbrains.annotations.Nullable String value) {
   ...
   */
  public static PageRankPregel.PageRankPregelConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, @org.jetbrains.annotations.Nullable String seedProperty, double dampingFactor) {
   ...
   * @return An immutable PageRankPregelConfig instance
   */
  public static PageRankPregel.PageRankPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, @org.jetbrains.annotations.Nullable String seedProperty, double dampingFactor) {
    return validate(new ImmutablePageRankPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, writeConcurrency, mutateProperty, writeProperty, seedProperty, dampingFactor));
  }
   ...
   * @return An immutable PageRankPregelConfig instance
   */
  public static PageRankPregel.PageRankPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, @Nullable String relationshipWeightProperty, int maxIterations, boolean isAsynchronous, Partitioning partitioning, int writeConcurrency, String mutateProperty, String writeProperty, @org.jetbrains.annotations.Nullable String seedProperty, double dampingFactor) {
    return validate(new ImmutablePageRankPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, maxIterations, isAsynchronous, partitioning, writeConcurrency, mutateProperty, writeProperty, seedProperty, dampingFactor));
  }
