...
public final class SingleSourceShortestPathPregelAlgorithm extends Algorithm<PregelResult> {
    ...
    SingleSourceShortestPathPregelAlgorithm(Graph graph,
            SingleSourceShortestPathPregel.SingleSourceShortestPathPregelConfig configuration,
            ProgressTracker progressTracker) {
        super(progressTracker);
        this.pregelJob = Pregel.create(graph, configuration, new SingleSourceShortestPathPregel(), Pools.DEFAULT, progressTracker);
    }
