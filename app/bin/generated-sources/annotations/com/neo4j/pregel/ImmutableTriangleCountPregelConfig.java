...
public final class ImmutableTriangleCountPregelConfig implements TriangleCountPregelConfig {
   ...
   */
  public final ImmutableTriangleCountPregelConfig withUsernameOverride(String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableTriangleCountPregelConfig withRelationshipWeightProperty(String value) {
    String newValue = value;
  ...
  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link TriangleCountPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * @param value The value for arrowConnectionInfo, {@code null} is accepted as {@code java.util.Optional.empty()}
   * @return A modified copy of {@code this} object
   */
  public final ImmutableTriangleCountPregelConfig withArrowConnectionInfo(WriteConfig.ArrowConnectionInfo value) {
  ...
  /**
   * Copy the current immutable object by setting an optional value for the {@link TriangleCountPregelConfig#arrowConnectionInfo() arrowConnectionInfo} attribute.
   * A shallow reference equality check is used on unboxed optional value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for arrowConnectionInfo
   * @return A modified copy of {@code this} object
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableTriangleCountPregelConfig withArrowConnectionInfo(Optional<? extends WriteConfig.ArrowConnectionInfo> optional) {
   ...
   */
  public static TriangleCountPregelConfig of(int concurrency, int minBatchSize, List<String> nodeLabels, List<String> relationshipTypes, Optional<String> relationshipWeightProperty, boolean isAsynchronous, Partitioning partitioning, Optional<WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, int maxIterations) {
    return of(concurrency, minBatchSize, (Iterable<String>) nodeLabels, (Iterable<String>) relationshipTypes, relationshipWeightProperty, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, maxIterations);
  }
   ...
   * @return An immutable TriangleCountPregelConfig instance
   */
  public static TriangleCountPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, Optional<String> relationshipWeightProperty, boolean isAsynchronous, Partitioning partitioning, Optional<? extends WriteConfig.ArrowConnectionInfo> arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, int maxIterations) {
    return validate(new ImmutableTriangleCountPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, maxIterations));
  }
   ...
   * @return An immutable TriangleCountPregelConfig instance
   */
  public static TriangleCountPregelConfig of(int concurrency, int minBatchSize, Iterable<String> nodeLabels, Iterable<String> relationshipTypes, String relationshipWeightProperty, boolean isAsynchronous, Partitioning partitioning, WriteConfig.ArrowConnectionInfo arrowConnectionInfo, int writeConcurrency, String mutateProperty, String writeProperty, int maxIterations) {
    return validate(new ImmutableTriangleCountPregelConfig(concurrency, minBatchSize, nodeLabels, relationshipTypes, relationshipWeightProperty, isAsynchronous, partitioning, arrowConnectionInfo, writeConcurrency, mutateProperty, writeProperty, maxIterations));
  }
   ...
   *    .arrowConnectionInfo(org.neo4j.gds.config.WriteConfig.ArrowConnectionInfo) // optional {@link TriangleCountPregelConfig#arrowConnectionInfo() arrowConnectionInfo}
  ...
  public static final class Builder {
    ...
    /**
     * Initializes the optional value {@link TriangleCountPregelConfig#arrowConnectionInfo() arrowConnectionInfo} to arrowConnectionInfo.
